...
# Deploys single-time azsk scanner to default kubernetes context
...
echo ""
echo "Deploying azsk scanner $SCANNER_ID job to namespace $K8S_NAMESPACE"
echo ""
...
cp "./k8s/templates/scanner_azsk_job.yaml.tmpl" ./working_dir/scanner_azsk.yaml
